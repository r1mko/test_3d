...
public class Hexagon : MonoBehaviour
{
    ...
    public void PlayJumpAnimation([Bridge.Ref] Vector3 targetPosition, [Bridge.Ref] Quaternion targetRotation, Action onComplete = null, float speedMultiplier = 1.0f)
    {
        StartCoroutine(JumpCoroutine(targetPosition, targetRotation, onComplete, speedMultiplier));
    }

    private IEnumerator JumpCoroutine(Vector3 targetPosition, [Bridge.Ref] Quaternion targetRotation, Action onComplete, float speedMultiplier)
    {
